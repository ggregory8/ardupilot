...
void Copter::land_gps_run()
{
    ...
    if (!ap.land_repo_active) {
        ...
        if ((g.irlock_alt != -1.0f) && (irlock_blob_detected == true)) {
            ...
            //Vector3f irlock_target_shift = precland.get_target_shift(wp_nav.get_loiter_target());
            irlock_target_shift = precland.get_target_shift(wp_nav.get_loiter_target());
            wp_nav.shift_loiter_target(irlock_target_shift);
