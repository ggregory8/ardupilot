...
// precision landing logging            // GG-IRlock3.3
...
// Write an optical flow packet         // GG-IRlock3.3
...
const struct LogStructure Copter::log_structure[] PROGMEM = {
    ...
    { LOG_PRECLAND_MSG, sizeof(log_Precland),                   // GG-IRlock3.3
      "PL",   "IBffffff",   "TimeMS,Heal,bX,bY,eX,eY,pX,pY" },  // GG-IRlock3.3
